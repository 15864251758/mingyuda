$(function(){
    ...
    $('.picScroll-left .bd ul li .pic').hover(function(){
        $(this).find('.pic-box').stop(true,false).animate({top:'-40px'});
    },function(){
        $(this).find('.pic-box').stop(true,false).animate({top:'236px'});
    })
    ...
    $('.slideTxtBox-cp .hd ul li:last').css('border','none');
})